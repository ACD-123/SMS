...
import 'package:sms/views/sellerabout.dart';
import 'package:sms/views/shop_experience.dart';

class CustomerSellerShop extends StatefulWidget {
  @override
  State<CustomerSellerShop> createState() => _SellerShopState();
}

class _SellerShopState extends State<CustomerSellerShop> {
