     ...
     appBar: customappbar(title: "Address Book"),
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage(
                            "assets/images/addressbookaddnewaddresmapimage.png"),fit: BoxFit.fill),
                    border: Border.all(color: Color(0xff2E3192), width: 2),
                    borderRadius: BorderRadius.circular(14.38)),
                    child: Center(child: Icon(Icons.place,size: 35.sp,
           ...
           Row(children: [
            Obx(() => GestureDetector(
              ...
              child: Container(height: 6.h,width: 20.w,decoration: BoxDecoration(
              border: Border.all(color: 
              homeguestcontroller.addnewaddresselecradrestype.value == 0 ? Color(0xff2E3192) : 
              Color(0xffDBDBDB)),
          ...
          custombutton(hinttext: "Add Address")
            ],
          ),
        ),
      ),
...
GestureDetector containerselectaddrestype(String title,int index){
 ...
 return GestureDetector(
  onTap: (){
   ...
   child: Obx(() => Container(height: 6.h,width: 20.w,decoration: BoxDecoration(
            border: Border.all(color:  homeguestcontroller.addnewaddresselecradrestype.value == index ? Color(0xff2E3192) : 
            Color(0xffDBDBDB)),
            borderRadius: BorderRadius.circular(10)),
            child:   Center(
              child: Text(
              ...
              fontWeight:homeguestcontroller.addnewaddresselecradrestype.value == index ? FontWeight.bold : FontWeight.w400,
              color: homeguestcontroller.addnewaddresselecradrestype.value == index ? Color(0xff2E3192) : 
          ...
          SizedBox(height: 1.h),
           GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Text("Add Type",style: TextStyle(
                              fontSize: 15.sp,
